...
return [
    ...
    Webkul\ParcelDaily\Providers\ParcelDailyServiceProvider::class,
    Webkul\Paydibs\Providers\PaymentServiceProvider::class,
    Webkul\Sms\Providers\SmsServiceProvider::class,
