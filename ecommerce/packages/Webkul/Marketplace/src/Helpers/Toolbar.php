...
class Toolbar
{
    ...
    public function getAvailableOrders(): Collection
    {
        return collect([
            [
                'title'    => trans('marketplace::app.shop.sellers.profile.products.sort-by.options.from-a-z'),
                'value'    => 'name-asc',
                'sort'     => 'name',
                'order'    => 'asc',
                'position' => 1,
            ...
            [
                'title'    => trans('marketplace::app.shop.sellers.profile.products.sort-by.options.from-z-a'),
                'value'    => 'name-desc',
                'sort'     => 'name',
                'order'    => 'desc',
                'position' => 2,
            ...
            [
                'title'    => trans('marketplace::app.shop.sellers.profile.products.sort-by.options.latest-first'),
            ...
            [
                'title'    => trans('marketplace::app.shop.sellers.profile.products.sort-by.options.oldest-first'),
            ...
            [
                'title'    => trans('marketplace::app.shop.sellers.profile.products.sort-by.options.cheapest-first'),
                'value'    => 'price-asc',
                'sort'     => 'price',
                'order'    => 'asc',
                'position' => 5,
            ...
            [
                'title'    => trans('marketplace::app.shop.sellers.profile.products.sort-by.options.expensive-first'),
                'value'    => 'price-desc',
                'sort'     => 'price',
                'order'    => 'desc',
                'position' => 6,
