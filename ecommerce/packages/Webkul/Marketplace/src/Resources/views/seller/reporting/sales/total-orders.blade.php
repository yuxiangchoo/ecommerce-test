...
<v-reporting-sales-total-orders>
    <!-- Shimmer -->
    <x-marketplace::seller.shimmer.reporting.sales.total-orders /> 
</v-reporting-sales-total-orders>
            ...
            <div class="rounded-xl border bg-white py-5 px-[30px]">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="flex-1 text-xl font-medium text-navyBlue">
                        @lang('marketplace::app.seller.reporting.sales.index.total-orders')
                    </p>

                    <a
                        href="{{ route('seller.reporting.sales.view', ['type' => 'total-orders']) }}"
                ...
                <div class="grid gap-4">
                    ...
                    <p class="text-sm font-normal">
                        @lang('marketplace::app.seller.reporting.sales.index.orders-over-time')
                    </p>
