...
<v-reporting-sales-total-refunds>
    <x-marketplace::seller.shimmer.reporting.sales.total-refunds />
</v-reporting-sales-total-refunds>
            ...
            <div class="rounded-xl border bg-white py-5 px-[30px]">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="flex-1 text-xl font-medium text-navyBlue">
                        @lang('marketplace::app.seller.reporting.sales.index.refunds')
                    </p>

                    <a
                        href="{{ route('seller.reporting.sales.view', ['type' => 'refunds']) }}"
                ...
                <div class="grid gap-4">
                    ...
                    <p class="text-sm font-normal">
                        @lang('marketplace::app.seller.reporting.sales.index.refunds-over-time')
                    </p>
