...
<v-reporting-sales-total-sales>
    <!-- Shimmer -->
    <x-marketplace::seller.shimmer.reporting.sales.total-sales />
</v-reporting-sales-total-sales>
            ...
            <div class="rounded-xl border bg-white py-6 px-[30px]">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="flex-1 text-xl font-medium text-navyBlue">
                        @lang('marketplace::app.seller.reporting.sales.index.total-sales')
                    </p>

                    <a
                        href="{{ route('seller.reporting.sales.view', ['type' => 'total-sales']) }}"
                ...
                <div class="grid gap-4">
                    ...
                    <p class="text-sm font-normal">
                        @lang('marketplace::app.seller.reporting.sales.index.sales-over-time')
                    </p>
