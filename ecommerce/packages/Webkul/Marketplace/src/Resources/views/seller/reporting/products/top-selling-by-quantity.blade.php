...
<v-reporting-product-top-selling-by-quantity>
    <!-- Shimmer -->
    <x-marketplace::seller.shimmer.reporting.products.top-selling-by-quantity />
</v-reporting-product-top-selling-by-quantity>
            ...
            <div class="rounded-xl border bg-white py-5 px-[30px]">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="flex-1 flex-1 text-xl font-medium text-navyBlue">
                        @lang('marketplace::app.seller.reporting.products.index.top-selling-products-by-quantity')
                    </p>

                    <a
                        href="{{ route('seller.reporting.products.view', ['type' => 'top-selling-products-by-quantity']) }}"
