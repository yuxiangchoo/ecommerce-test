            ...
            template: '#v-notifications-template',
                ...
                data() {
                    return {
                        ...
                        {{ \Webkul\Sales\Models\Order::STATUS_TO_PROCESS }}: "@lang('admin::app.notifications.order-status-messages.to-process')",
                        ...
                        {{ \Webkul\Sales\Models\Order::STATUS_PAYMENT_FAILED }}: "@lang('admin::app.notifications.order-status-messages.payment-failed')",    
                        }
                    }
                },
