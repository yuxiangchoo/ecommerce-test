...
class OrderDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        ...
        $this->addColumn([
            ...
            'filterable_options' => [
                [
                    'label'  => trans('shop::app.customers.account.orders.status.options.to-process'),
                ...
                [
                    ...
                    'value'  => Order::STATUS_PENDING_PAYMENT,
                                ...
                                [
                    'label'  => trans('shop::app.customers.account.orders.status.options.payment-failed'),
            ...
            'closure'    => function ($row) {
                switch ($row->status) {
                    case Order::STATUS_TO_PROCESS:
                        return '<p class="label-pending">'.trans('shop::app.customers.account.orders.status.options.to-process').'</p>';
