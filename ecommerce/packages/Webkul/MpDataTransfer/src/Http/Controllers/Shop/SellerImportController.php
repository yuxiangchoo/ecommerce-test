...
namespace Webkul\MpDataTransfer\Http\Controllers\Shop;
...
use Webkul\MpDataTransfer\Datagrids\Shop\ImportDataGrid;
use ZipArchive;

class SellerImportController extends Controller
{
    /**
     * @var 'import/'
     */
    ...
    public function index()
    {
        ...
        return view('mp_data_transfer::shop.sellers.account.seller-data-transfer.index');
    }
    ...
    {
        return view('mp_data_transfer::shop.sellers.account.seller-data-transfer.create');
    }
    ...
    public function store()
    {
        ...
        request()->merge(['seller' => auth()->guard('seller')->user()->id]);

        Event::dispatch('data_transfer.imports.create.after', $import);

        session()->flash('success', trans('mp_data_transfer::app.shop.sellers.account.seller-data-transfer.imports.create-success'));

        return redirect()->route('shop.mp_data_transfer.seller.account.seller_data_transfer.imports.import', $import->id);
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('mp_data_transfer::shop.sellers.account.seller-data-transfer.edit', compact('import'));
    }
    ...
    public function update(int $id)
    {
        ...
        session()->flash('success', trans('mp_data_transfer::app.shop.sellers.account.seller-data-transfer.imports.update-success'));
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return new JsonResponse([
                'message' => trans('mp_data_transfer::app.shop.sellers.account.seller-data-transfer.imports.delete-success'),
            ]);
        } catch (\Exception $e) {
        }

        return response()->json([
            'message' => trans('mp_data_transfer::app.shop.sellers.account.seller-data-transfer.imports.delete-failed'),
        ], 500);
    }
    ...
    public function import(int $id)
    {
        ...
        return view('mp_data_transfer::shop.sellers.account.seller-data-transfer.import', compact('import', 'isValid', 'stats'));
    }
    ...
    public function start(int $id): JsonResponse
    {
        ...
        if (! $import->processed_rows_count) {
            return new JsonResponse([
                'message' => trans('mp_data_transfer::app.shop.sellers.account.seller-data-transfer.imports.nothing-to-import'),
            ], 400);
        }
        ...
        if (! $this->importHelper->isValid()) {
            return new JsonResponse([
                'message' => trans('mp_data_transfer::app.shop.sellers.account.seller-data-transfer.imports.not-valid'),
            ], 400);
        }
        ...
        if (
            ...
            return new JsonResponse([
                'message' => trans('mp_data_transfer::app.shop.sellers.account.seller-data-transfer.imports.setup-queue-error'),
            ], 400);
        }
    ...
    public function download(int $id)
    {
        ...
        // TODO need to verify with the current active user
