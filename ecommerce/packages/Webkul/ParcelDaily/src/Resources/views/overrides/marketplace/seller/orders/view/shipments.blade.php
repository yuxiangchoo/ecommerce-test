        ...
        <table class="text-left text-sm">
            ...
            <tr>
                ...
                <td class="px-2.5 text-sm">-</td>
                 ...
                 <td class="text-sm">
                    @if (!empty($sellerShipment->shipment->track_number))
                        <a href="{{ route('parceldaily.seller.tracking.show', $sellerShipment->shipment->track_number) }}"
                        onclick="window.open(this.href,'pdTracking','width=900,height=700,menubar=0,toolbar=0,location=0,status=0,resizable=1,scrollbars=1'); return false;"
