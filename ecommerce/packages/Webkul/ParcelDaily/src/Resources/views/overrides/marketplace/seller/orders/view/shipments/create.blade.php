@php
    ...
    $__pd_is_parceldaily = \Illuminate\Support\Str::startsWith($sellerOrder->order->shipping_method ?? '', 'parceldaily');
@endphp
                ...
                <x-marketplace::seller.modal ref="shipment">
                    ...
                    <x-slot:content class="!p-4">
                        ...
                        <div class="grid">
                            ...
                            @if ($__pd_is_parceldaily)
                                <!-- ParcelDaily: Shipment Mode -->
                                <x-shop::form.control-group>
                                    <x-shop::form.control-group.label class="required">
                                        @lang('parceldaily::app.create-shipment.shipment-mode')
                                    </x-shop::form.control-group.label>
                                    ...
                                    <x-shop::form.control-group.control
                                        ...
                                        class="!mb-0 !shadow-none"
                                        rules="required"
                                        :label="trans('parceldaily::app.create-shipment.shipment-mode')"
                                        :placeholder="trans('parceldaily::app.create-shipment.shipment-mode')"
                                    >
                                        <option value="pickup">@lang('parceldaily::app.create-shipment.pick-up')</option>
                                        <option value="dropoff">@lang('parceldaily::app.create-shipment.drop-off')</option>
                                    </x-shop::form.control-group.control>

                                    <x-shop::form.control-group.error
                                        class="mt-1 flex"
                                        control-name="pd_mode"
                                    />
                                </x-shop::form.control-group>
                            @endif
