...
class OrderDataGrid extends DataGrid
{
    ...
    public function prepareColumns()
    {
        ...
        $this->addColumn([
            ...
            'filterable_options' => [
                [
                    'label' => trans('admin::app.customers.customers.view.datagrid.orders.to-process'),
                ...
                [
                    'label' => trans('admin::app.customers.customers.view.datagrid.orders.payment-failed'),
            ...
            'closure'    => function ($row) {
                switch ($row->status) {
                    case Order::STATUS_TO_PROCESS:
                        return '<p class="label-pending">'.trans('admin::app.customers.customers.view.datagrid.orders.to-process').'</p>';
                    ...
                    case Order::STATUS_PAYMENT_FAILED:
                        return '<p class="label-pending">'.trans('admin::app.customers.customers.view.datagrid.orders.payment-failed').'</p>';
