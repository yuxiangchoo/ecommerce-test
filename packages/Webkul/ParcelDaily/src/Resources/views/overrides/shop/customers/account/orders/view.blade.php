    ...
    <div class="mx-4 flex-auto max-md:mx-6 max-sm:mx-4">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-1.5">
                ...
                @if ($order->canCancel() && $order->shipments->isEmpty())
                    <form
                        method="POST"
                        ref="cancelOrderForm"
                            ...
                            @foreach ($order->shipments as $shipment)
                                ...
                                <div class="max-md:hidden">
                                    <div>
                                        ...
                                        <span>
                                            <a href="{{ route('parceldaily.shop.tracking.show', $shipment->track_number) }}"
                                                onclick="window.open(this.href, 'trackingWindow', 'width=900,height=700,menubar=0,toolbar=0,location=0,status=0,resizable=1,scrollbars=1'); return false;"
