@php
    $pdShipment = \Webkul\ParcelDaily\Models\OrderShipment::query()
...
<x-marketplace::seller.layouts>
    ...
    <div class="flex items-center justify-between gap-4 max-xl:flex-wrap">
        ...
        <div class="flex items-center gap-2.5">
            ...
            @if ($pdShipment && $pdShipment->connote)
                <a href="{{ route('parceldaily.seller.shipments.print-waybill', $pdShipment->id) }}"
                target="_blank"
                class="secondary-button px-5 py-2.5">
                    @lang('parceldaily::app.print-waybill')
                </a>
            @endif
