                                ...
                                <ul class="inline-flex items-center -space-x-px rounded-lg border border-zinc-200 max-md:px-0">
                                    ...
                                    <li>
                                        <input
                                            ...
                                            class="max-md:max-w-9 max-w-[42px] items-center border-l border-r px-4 py-2 font-medium leading-normal text-black hover:bg-gray-100 max-md:justify-normal max-md:px-0 max-md:py-1 max-md:text-center"
