...
@pushOnce('scripts')
    ...
    >
        <div class="select-none">
            ...
            <div class="relative group">
                ...
                <div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300">
                    <div
                        ...
                        @click="open"
                    >
                        <span class="icon-zoom text-2xl text-white"></span>
                    </div>
                </div>
            </div>
            ...
            >
                <div
                    class="fixed inset-0 z-[10002] bg-black bg-opacity-90 dark:bg-opacity-80"
                    v-if="isOpen"
                >
                </div>
            </transition>
            ...
            >
                ...
                >
                    <div class="relative max-w-6xl w-full mx-auto">
                        <!-- Close -->
                        <button
                            class="flex absolute top-4 right-4 bg-white bg-opacity-80 dark:bg-gray-700 dark:bg-opacity-80 rounded-full p-2 shadow hover:bg-opacity-100 z-10"
                            @click="close"
                        >
                            <span class="icon-cross text-2xl text-black dark:text-white"></span>
                        </button>

                        <!-- Image -->
                        <div class="bg-white bg-opacity-5 backdrop-blur-sm dark:bg-gray-800 dark:bg-opacity-40 rounded-lg p-1 shadow-2xl">
                            ...
                            <!-- Controls -->
                            <div class="flex justify-between items-center p-4 bg-black bg-opacity-50 dark:bg-opacity-60 text-white rounded-b-lg">
                                <div class="flex gap-3">
                                    <!-- Zoom In -->
                                    <button
                                        class="p-2 hover:bg-white hover:bg-opacity-20 dark:hover:bg-white dark:hover:bg-opacity-20 rounded-full"
                                        @click="zoomIn"
                                    >
                                        <svg
