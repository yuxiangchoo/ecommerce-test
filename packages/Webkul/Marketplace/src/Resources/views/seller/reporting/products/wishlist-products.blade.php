...
<v-reporting-products-wishlist-products>
    <!-- Shimmer -->
    <x-marketplace::seller.shimmer.reporting.products.wishlist-products />
</v-reporting-products-wishlist-products>
            ...
            <div class="rounded-xl border bg-white py-5 px-[30px]">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="flex-1 text-xl font-medium text-navyBlue">
                        @lang('marketplace::app.seller.reporting.products.index.total-products-added-to-wishlist')
                    </p>

                    <a
                        href="{{ route('seller.reporting.products.view', ['type' => 'total-products-added-to-wishlist']) }}"
                ...
                <div class="grid gap-4">
                    ...
                    <p class="text-sm font-normal">
                        @lang('marketplace::app.seller.reporting.products.index.products-added-over-time')
                    </p>
