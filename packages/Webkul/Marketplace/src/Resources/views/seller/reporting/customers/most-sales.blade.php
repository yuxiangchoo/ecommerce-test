...
<v-reporting-customers-with-most-sales>
    <!-- Shimmer -->
    <x-marketplace::seller.shimmer.reporting.customers.most-sales />
</v-reporting-customers-with-most-sales>
            ...
            <div class="rounded-xl border bg-white py-5 px-[30px]">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="flex-1 text-xl font-medium text-navyBlue">
                        @lang('marketplace::app.seller.reporting.customers.index.customers-with-most-sales')
                    </p>

                    <a
                        href="{{ route('seller.reporting.customers.view', ['type' => 'customers-with-most-sales']) }}"
