...
<v-reporting-sales-average-order-value>
    <!-- Shimmer -->
    <x-marketplace::seller.shimmer.reporting.sales.average-order-value /> 
</v-reporting-sales-average-order-value>
            ...
            <div class="rounded-xl border bg-white py-5 px-[30px]">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="flex-1 text-xl font-medium text-navyBlue">
                        @lang('marketplace::app.seller.reporting.sales.index.average-sales')
                    </p>

                    <a
                        href="{{ route('seller.reporting.sales.view', ['type' => 'average-sales']) }}"
                ...
                <div class="grid gap-4">
                    ...
                    <p class="text-sm font-normal">
                        @lang('marketplace::app.seller.reporting.sales.index.average-order-value-over-time')
                    </p>
