...
<v-reporting-products-total-sold-quantity>
    <!-- Shimmer -->
    <x-marketplace::seller.shimmer.reporting.products.sold-quantities />
</v-reporting-products-total-sold-quantity>
            ...
            <div class="rounded-xl border bg-white py-5 px-[30px]">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="flex-1 text-xl font-medium text-navyBlue">
                        @lang('marketplace::app.seller.reporting.products.index.total-sold-quantities')
                    </p>

                    <a
                        href="{{ route('seller.reporting.products.view', ['type' => 'total-sold-quantities']) }}"
                ...
                <div class="grid gap-4">
                    ...
                    <p class="text-sm font-normal">
                        @lang('marketplace::app.seller.reporting.products.index.quantities-sold-over-time')
                    </p>
