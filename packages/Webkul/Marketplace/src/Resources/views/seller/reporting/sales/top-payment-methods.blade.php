...
<v-reporting-sales-top-payment-methods>
    <!-- Shimmer -->
    <x-marketplace::seller.shimmer.reporting.sales.top-payment-methods />
</v-reporting-sales-top-payment-methods>
            ...
            <div class="rounded-xl border bg-white py-5 px-[30px]">
                ...
                <div class="mb-4 flex items-center justify-between">
                    <p class="flex-1 text-xl font-medium text-navyBlue">
                        @lang('marketplace::app.seller.reporting.sales.index.top-payment-methods')
                    </p>

                    <a
                        href="{{ route('seller.reporting.sales.view', ['type' => 'top-payment-methods']) }}"
