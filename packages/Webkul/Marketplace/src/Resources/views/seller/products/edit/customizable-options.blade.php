@if ($product->getTypeInstance()->isCustomizable())
    ...
    {!! view_render_event('bagisto.seller.product.edit.form.customizable-options.before', ['product' => $product]) !!}

    <v-customizable-options :errors="errors"></v-customizable-options>

    {!! view_render_event('bagisto.seller.product.edit.form.customizable-options.after', ['product' => $product]) !!}
    ...
    @pushOnce('scripts')
        ...
        >
            <div class="box-shadow relative rounded-xl border bg-white">
                <!-- Option Panel Header -->
                <div class="p-5 flex flex-col mb-2.5">
                    <div class="flex justify-between gap-5">
                        <!-- Option Title & Option Info -->
                        <div class="flex flex-col gap-2">
                            <p class="text-base font-semibold text-gray-800">
                                @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.title')
                            </p>

                            <p class="text-xs font-medium text-gray-500">
                                @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.info')
                            </p>
                        </div>
                        ...
                        <div class="flex items-center gap-x-1">
                            ...
                            >
                                @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.add-btn')
                            </div>
                        </div>
                    </div>

                    <!-- Backend Validations -->
                    <x-marketplace::seller.form.control-group.error control-name="customizable_options" />
                </div>
                    ...
                    >
                        <template #item="{ element, index }">
                            <div>
                                ...
                                -->
                                <div
                                    class="mb-2.5 flex justify-between gap-5 p-5"
                                    v-if="! canHaveMultiplePrices(element.type)"
                                >
                                    <!-- Option Information -->
                                    ...
                                    <div class="grid place-content-start gap-1 ltr:text-right rtl:text-left">
                                        ...
                                        <div class="flex gap-2">
                                            ...
                                            >
                                                @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.option.edit-btn')
                                            </p>
                                            ...
                                            >
                                                @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.option.delete-btn')
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                >
                    ...
                    <div class="flex flex-col items-center gap-1.5">
                        <p class="text-base font-semibold text-gray-400">
                            @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.empty-title')
                        </p>

                        <p class="text-gray-400">
                            @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.empty-info')
                        </p>
                    </div>
                        ...
                        <x-marketplace::seller.modal ref="updateCreateOptionModal">
                            ...
                            <x-slot:header>
                                <p class="text-lg font-bold text-gray-800">
                                    @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.update-create.title')
                                </p>
                            </x-slot>
                            ...
                            <x-slot:content>
                                <x-marketplace::seller.form.control-group>
                                    <x-marketplace::seller.form.control-group.label class="required">
                                        @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.update-create.name')
                                    ...
                                    <x-marketplace::seller.form.control-group.control
                                        ...
                                        :label="trans('marketplace::app.seller.products.edit.types.simple.customizable-options.update-create.name')"
                                    />

                                    <x-marketplace::seller.form.control-group.error control-name="label" />
                                </x-marketplace::seller.form.control-group>

                                <div class="flex gap-4">
                                    <x-marketplace::seller.form.control-group class="flex-1">
                                        <x-marketplace::seller.form.control-group.label class="required">
                                            @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.update-create.type')
                                        </x-marketplace::seller.form.control-group.label>
                                        ...
                                        <x-marketplace::seller.form.control-group.control
                                            ...
                                            :label="trans('marketplace::app.seller.products.edit.types.simple.customizable-options.update-create.type')"
                                        >
                                            <option
                                                :value="type.key"
                                                :key="key"
                                    ...
                                    <x-marketplace::seller.form.control-group class="flex-1">
                                        <x-marketplace::seller.form.control-group.label class="required">
                                            @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.update-create.is-required')
                                        </x-marketplace::seller.form.control-group.label>
                                        ...
                                        <x-marketplace::seller.form.control-group.control
                                            ...
                                            :label="trans('marketplace::app.seller.products.edit.types.simple.customizable-options.update-create.is-required')"
                                        >
                                            <option value="1">
                                                @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.update-create.yes')
                                            </option>

                                            <option value="0">
                                                @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.update-create.no')
                                            </option>
                                        </x-marketplace::seller.form.control-group.control>

                                        <x-marketplace::seller.form.control-group.error control-name="is_required" />
                                    </x-marketplace::seller.form.control-group>
                                </div>

                                <template v-if="! canHaveMultiplePrices(selectedOption.type)">
                                    <x-marketplace::seller.form.control-group v-if="['text', 'textarea'].includes(selectedOption.type)">
                                        <x-marketplace::seller.form.control-group.label class="required">
                                            @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.update-create.max-characters')
                                        </x-marketplace::seller.form.control-group.label>
                                        ...
                                        <x-marketplace::seller.form.control-group.control
                                            ...
                                            :label="trans('marketplace::app.seller.products.edit.types.simple.customizable-options.update-create.max-characters')"
                                        />

                                        <x-marketplace::seller.form.control-group.error control-name="max_characters" />
                                    </x-marketplace::seller.form.control-group>

                                    <x-marketplace::seller.form.control-group v-else-if="selectedOption.type == 'file'">
                                        <x-marketplace::seller.form.control-group.label class="required">
                                            @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.update-create.supported-file-extensions')
                                        </x-marketplace::seller.form.control-group.label>
                                        ...
                                        <x-marketplace::seller.form.control-group.control
                                            ...
                                            :label="trans('marketplace::app.seller.products.edit.types.simple.customizable-options.update-create.supported-file-extensions')"
                                        />

                                        <x-marketplace::seller.form.control-group.error control-name="supported_file_extensions" />
                                    </x-marketplace::seller.form.control-group>

                                    <x-marketplace::seller.form.control-group>
                                        <x-marketplace::seller.form.control-group.label class="required">
                                            @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.update-create.price')
                                        </x-marketplace::seller.form.control-group.label>
                                        ...
                                        <x-marketplace::seller.form.control-group.control
                                            ...
                                            :label="trans('marketplace::app.seller.products.edit.types.simple.customizable-options.update-create.price')"
                                        />
                            ...
                            <x-slot:footer>
                                ...
                                <x-shop::button
                                    ...
                                    :title="trans('marketplace::app.seller.products.edit.types.simple.customizable-options.update-create.save-btn')"
                                />
                            </x-slot>
        ...
        >
            ...
            <div>
                <!-- Panel Header -->
                <div class="p-5 mb-2.5 flex justify-between gap-5">
                    <!-- Option Information -->
                    <div class="flex gap-2.5">
                        <i class="icon-drag cursor-grab text-xl transition-all hover:text-gray-700"></i>
                    ...
                    <div class="flex items-center gap-x-5">
                        ...
                        >
                            @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.option.add-btn')
                        </p>
                ...
                >
                    ...
                    >
                        <template #item="{ element, index }">
                            <div class="flex justify-between gap-2.5 border-b border-slate-300 p-5">
                                <!--
                                    Hidden Attributes:
                ...
                >
                    ...
                    <div class="flex flex-col items-center gap-1.5">
                        <p class="text-base font-semibold text-gray-400">
                            @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.option.empty-title')
                        </p>

                        <p class="text-gray-400">
                            @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.option.empty-info')
                        </p>
                    </div>
            ...
            >
                ...
                >
                    <x-marketplace::seller.modal ref="updateCreateOptionItemModal">
                        <!-- Option Item Modal Header -->
                        <x-slot:header>
                            <p class="text-lg font-bold text-gray-800">
                                @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.option.items.update-create.title')
                            </p>
                        </x-slot>
                        ...
                        <x-slot:content>
                            <div class="flex gap-2">
                                ...
                                <x-marketplace::seller.form.control-group>
                                    <x-marketplace::seller.form.control-group.label class="required">
                                        @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.option.items.update-create.label')
                                    </x-marketplace::seller.form.control-group.label>
                                    ...
                                    <x-marketplace::seller.form.control-group.control
                                        ...
                                        rules="required"
                                        :label="trans('marketplace::app.seller.products.edit.types.simple.customizable-options.option.items.update-create.label')"
                                    />
                                ...
                                <x-marketplace::seller.form.control-group>
                                    <x-marketplace::seller.form.control-group.label class="required">
                                        @lang('marketplace::app.seller.products.edit.types.simple.customizable-options.option.items.update-create.price')
                                    </x-marketplace::seller.form.control-group.label>
                                    ...
                                    <x-marketplace::seller.form.control-group.control
                                        ...
                                        rules="required|decimal|min_value:0"
                                        :label="trans('marketplace::app.seller.products.edit.types.simple.customizable-options.option.items.update-create.price')"
                                    />
                        ...
                        <x-slot:footer>
                            ...
                            <x-shop::button
                                button-type="button"
                                class="primary-button"
                                :title="trans('marketplace::app.seller.products.edit.types.simple.customizable-options.option.items.update-create.save-btn')"
                            />
                        </x-slot>
                    </x-marketplace::seller.modal>
                </form>
                    ...
                    return {
                        types: {
                            text: {
                                ...
                                title: "@lang('marketplace::app.seller.products.edit.types.simple.customizable-options.option.types.text.title')",
                            },

                            textarea: {
                                key: 'textarea',
                                canHaveMultiplePrices: false,
                                title: "@lang('marketplace::app.seller.products.edit.types.simple.customizable-options.option.types.textarea.title')",
                            },

                            checkbox: {
                                key: 'checkbox',
                                canHaveMultiplePrices: true,
                                title: "@lang('marketplace::app.seller.products.edit.types.simple.customizable-options.option.types.checkbox.title')",
                            },

                            radio: {
                                key: 'radio',
                                canHaveMultiplePrices: true,
                                title: "@lang('marketplace::app.seller.products.edit.types.simple.customizable-options.option.types.radio.title')",
                            },

                            select: {
                                key: 'select',
                                canHaveMultiplePrices: true,
                                title: "@lang('marketplace::app.seller.products.edit.types.simple.customizable-options.option.types.select.title')",
                            },

                            multiselect: {
                                key: 'multiselect',
                                canHaveMultiplePrices: true,
                                title: "@lang('marketplace::app.seller.products.edit.types.simple.customizable-options.option.types.multiselect.title')",
                            },

                            date: {
                                key: 'date',
                                canHaveMultiplePrices: false,
                                title: "@lang('marketplace::app.seller.products.edit.types.simple.customizable-options.option.types.date.title')",
                            },

                            datetime: {
                                key: 'datetime',
                                canHaveMultiplePrices: false,
                                title: "@lang('marketplace::app.seller.products.edit.types.simple.customizable-options.option.types.datetime.title')",
                            },

                            time: {
                                key: 'time',
                                canHaveMultiplePrices: false,
                                title: "@lang('marketplace::app.seller.products.edit.types.simple.customizable-options.option.types.time.title')",
                            },

                            file: {
                                key: 'file',
                                canHaveMultiplePrices: false,
                                title: "@lang('marketplace::app.seller.products.edit.types.simple.customizable-options.option.types.file.title')",
                            },
                        },
