        ...
        <div class="grid justify-center justify-items-center gap-3.5 px-2.5 py-10">
            ...
            <div class="flex flex-col items-center gap-2">
                <p
                    ...
                    v-if="type == 'event'"
                >
                    @lang('marketplace::app.seller.products.edit.types.booking.empty-info.tickets.add')
                </p>
                ...
                <p
                    ...
                    v-else
                >
                    @lang('marketplace::app.seller.products.edit.types.booking.empty-info.slots.add')
                </p>

                <p class="text-gray-400">
                    @lang('marketplace::app.seller.products.edit.types.booking.empty-info.slots.description')
                </p>
            </div>
        </div>
    </script>
