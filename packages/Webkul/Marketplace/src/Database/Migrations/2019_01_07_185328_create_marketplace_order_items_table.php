...
class CreateMarketplaceOrderItemsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('marketplace_order_items', function (Blueprint $table) {
            ...
            $table->foreign('marketplace_product_id')->references('id')->on('marketplace_products')->nullOnDelete();
            $table->foreign('marketplace_order_id')->references('id')->on('marketplace_orders')->cascadeOnDelete();
            $table->foreign('parent_id')->references('id')->on('marketplace_order_items')->cascadeOnDelete();
        });
    }
